...
const categoryLinks = [
  ...
  { href: "/categories/appetizer", label: "Appetizers" },
  { href: "/categories/soup", label: "Soups" },
  { href: "/categories/breakfast", label: "Breakfast" },
];
...
export function Footer() {
  return (
    <footer className="relative border-t bg-secondary/50">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <input
                ...
                className="h-10 flex-1 rounded-full border bg-background px-4 text-sm placeholder:text-muted-foreground/60 focus:outline-none focus:ring-2 focus:ring-primary/30"
                required
              />
              <button
                type="submit"
                className="h-10 rounded-full bg-primary px-5 text-sm font-semibold text-primary-foreground transition-opacity hover:opacity-90"
              >
                Subscribe
              </button>
            </form>
